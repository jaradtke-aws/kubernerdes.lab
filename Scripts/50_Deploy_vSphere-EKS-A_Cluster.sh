...
#     Purpose: Deploy EKS Anywhere Cluster on vSphere 
#        Date: 2024-07-01
#      Status: GTG
# Assumptions:
#        Todo:
...
curl -o $CLUSTER_CONFIG.vanilla https://raw.githubusercontent.com/jaradtke-aws/kubernerdes.lab/main/Files/$CLUSTER_CONFIG_SOURCE
